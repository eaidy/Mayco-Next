        ...
        <>
            ...
            <main className="wrapper bg-light">
                <div className="model-image-top">
                    <Image src="/images/marinehome/J45-1.jpg" height={800} width={1600} alt="..."/>
                </div>
                        ...
                        <div className="row">
                            <div className="col-6">
                                <div className="p-3 d-flex">
                                    <Image src={MarineObject.models.J45.logo} height={300} width={150} alt="..."/>
                                </div>
                            </div>
                            <div className="col-6">
                                <ReactPlayer 
                            ...
                            <div className="col-12 d-flex justify-content-center">
                                <div className="table-container text-center p-4">
                                    ...
                                    <table className="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            {
                                                MarineObject.models.J45.table.rows.map((spec) => (
